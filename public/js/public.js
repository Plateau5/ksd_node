...
function searchBusinessList (firstLetter) {
    ...
    var applytoBusiness = $("select#applyBusiness option:selected").val();   // 商户-配置金融产品-适用业务
    ...
    /*applytoBusiness && $("#"+id).append('<input type="hidden" id="applyto_car" name="car_type" value="'+ applytoBusiness +'" />');*/
